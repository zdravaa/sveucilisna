...
app.config(['$stateProvider',
  function ($stateProvider) {
    ...
    .state('fixtures', {
      abstract: true,
      url: '/fixtures',
      templateUrl: 'admin/views/fixtures/main.html'
 })

    .state('fixtures.list', {
      url: '',
      templateUrl: 'admin/views/fixtures/list.html',
      controller: 'FixturesListCtrl'
 })

    .state('fixtures.add', {
      url: '/add',
      templateUrl: 'admin/views/fixtures/edit.html',
  ...
  .state('fixtures.getById', {
        url: '/getById/{id}',
        templateUrl: 'admin/views/fixtures/getFixtureData.wsdl',
        controller: 'FixturesEditCtrl'
   })

    .state('fixtures.item', {
      url: '/{id}',
      templateUrl: 'admin/views/fixtures/item.html',
