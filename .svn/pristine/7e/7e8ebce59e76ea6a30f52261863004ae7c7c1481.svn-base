...
app.config(['$stateProvider',
  function ($stateProvider) {
    ...
    .state('teams', {
      abstract: true,
      url: '/teams',
      templateUrl: 'admin/views/teams/main.html'
 })

    .state('teams.list', {
      url: '',
      templateUrl: 'admin/views/teams/list.html',
      controller: 'TeamsListCtrl'
 })

    .state('teams.add', {
      url: '/add',
      templateUrl: 'admin/views/teams/edit.html',
    ...
    .state('teams.item', {
      url: '/{id}',
      templateUrl: 'admin/views/teams/item.html',
